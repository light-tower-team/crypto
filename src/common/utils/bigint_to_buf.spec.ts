import { bigIntToBuf } from "./bigint_to_buf";
import { NegativeIntegerError } from "./bigint_to_hex";
import { bufToBigInt } from "./buf_to_bigint";

describe("bigint and buf", () => {
  it("should correct encode/decode", () => {
    const a = 17089213339746507438148031875678623280n;
    const buf = new Uint8Array([12, 219, 67, 68, 224, 20, 227, 75, 51, 52, 208, 4, 211, 58, 86, 48]).buffer;
